 ...
 */
public abstract class WithoutDialogCallback extends StringCallback {  Context context ;
    public abstract void onSuccess(String respose);
    public WithoutDialogCallback(Context context){
    ...
    public void onError(Call call, Response response, Exception e) {
        ...
        ToastUtils.showShort(context,"服务器连接超时，请重试");
    }
